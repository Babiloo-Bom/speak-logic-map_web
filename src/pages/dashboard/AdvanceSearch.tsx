...
import { ADVANCE_SEARCH_FILTERS } from "@/lib/pages/dashboard/constants";
import { IDataRequestGetList } from "@/lib/pages/dashboard/type";
...
function AdvanceSearch(props: Props) {
  const { open, onClose, dataRequest, setDataRequest, handleClearAllFormSearch } = props;
      ...
      <Drawer
        ...
        footer={
          <div className="flex items-center justify-between border-t border-blue-500/40">
            ...
            <Button type="text" onClick={onClose} className="w-1/2 h-12 text-primary font-semibold rounded-none hover:bg-transparent">
              APPLY
            </Button>
          </div>
        }
