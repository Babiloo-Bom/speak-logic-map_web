...
const FunctionRatingDetailPage = () => {
  ...
  const [data, setData] = useState<ViewRatingData | null>(null);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8">
      ...
      {/* Info box: Manager or Provider details — titles #324899, answers on line below */}
      ...
      {hasNoRating ? null : (
        <>
          {/* Function Rating section — title + stars centered; Q&A: title #324899, answer on line below */}
          <Card className="rounded-xl mb-8">
